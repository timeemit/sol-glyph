...
#   --create-disk=auto-delete=yes,boot=yes,device-name=builder-2,image=projects/ubuntu-os-cloud/global/images/ubuntu-1804-bionic-v20220213,mode=rw,size=10,type=projects/solana-paint/zones/us-central1-a/diskTypes/pd-balanced \
...
announce 'Build fmt'
gssh 'git clone https://github.com/fmtlib/fmt.git && mkdir fmt/_build && cd fmt/_build && cmake .. && make -j$(nproc) && sudo make install'

announce 'Configure & Build'
